            ...
            <ContainerTestQuestion active={cutScene?  'active' : ''}>
                ...
                <Box justify='space-between' align="center" direction='row' >
                    ...
                    {playing?  
                        ...
                        <path d="M15.9069 14.8595V6.40947H15.9251V1.34987C15.9259 1.23944 15.9031 1.13011 15.8585 1.02911C15.8138 0.928114 
                        ...
                        16.2 15.9467 15.7564 15.9472 15.3067C15.9457 15.1568 15.9322 15.0072 15.9069 14.8595Z" fill="#3A8CE4"/>
                        </svg>)
                        :
                        (<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.9069 17.8595V9.40947H18.9251V4.34987C18.9258 4.23944 18.9031 4.13011 18.8584 4.02911C18.8137 3.92811 18.7481 
                        ...
                        18.3067C18.9457 18.1568 18.9322 18.0072 18.9069 17.8595Z" fill="#BEC3CE"/>
