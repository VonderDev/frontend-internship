                        ...
                        {contentData.content_type.map((item: any, index) => (
                            <div key={index} style={{ marginRight: '10px', marginBottom: '5px' }}>
                                <CustomCheckableTag key={index} checked={selectedCatagories.indexOf(item) > -1} onChange={(checked) => handleChangeCatagories(item, checked)}>
                                    ...
                                    <div style={{ marginLeft: '5px', transform: 'translateY(1px)' }}>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="10" cy="10" r="10" fill="#FAFAFC"/>
                                    <g clipPath="url(#clip0)">
                                    <path d="M5.00918 6.6754L13.3241 14.9904C13.4333 15.0996 13.563 15.1862 13.7056 15.2453C13.8483 15.3044 14.0012 15.3348 14.1556 15.3348C14.3101 15.3348 14.463 15.3044 14.6056 15.2453C14.7483 15.1862 14.8779 15.0996 14.9871 14.9904C15.0963 14.8812 15.183 14.7515 15.2421 14.6089C15.3012 14.4662 15.3316 14.3133 15.3316 14.1589C15.3316 14.0044 15.3012 13.8515 15.2421 13.7089C15.183 13.5662 15.0963 13.4366 14.9871 13.3274L6.67217 5.01241C6.56298 4.90321 6.43335 4.81659 6.29068 4.75749C6.14801 4.69839 5.9951 4.66797 5.84067 4.66797C5.68625 4.66797 5.53333 4.69839 5.39066 4.75749C5.248 4.81659 5.11837 4.90321 5.00918 5.01241C4.89997 5.1216 4.81335 5.25123 4.75425 5.3939C4.69515 5.53657 4.66473 5.68948 4.66473 5.84391C4.66473 5.99833 4.69515 6.15124 4.75425 6.29391C4.81335 6.43658 4.89997 6.56621 5.00918 6.6754Z" fill="#3A8CE4"/>
                                    <path d="M13.3241 5.01241L5.00918 13.3274C4.89997 13.4366 4.81335 13.5662 4.75425 13.7089C4.69515 13.8515 4.66473 14.0044 4.66473 14.1589C4.66473 14.3133 4.69515 14.4662 4.75425 14.6089C4.81335 14.7515 4.89997 14.8812 5.00918 14.9904C5.11837 15.0996 5.248 15.1862 5.39066 15.2453C5.53333 15.3044 5.68625 15.3348 5.84067 15.3348C5.9951 15.3348 6.14801 15.3044 6.29068 15.2453C6.43335 15.1862 6.56298 15.0996 6.67217 14.9904L14.9871 6.6754C15.0963 6.56621 15.183 6.43658 15.2421 6.29391C15.3012 6.15124 15.3316 5.99833 15.3316 5.84391C15.3316 5.68948 15.3012 5.53657 15.2421 5.3939C15.183 5.25123 15.0963 5.1216 14.9871 5.01241C14.8779 4.90321 14.7483 4.81659 14.6056 4.75749C14.463 4.69839 14.3101 4.66797 14.1556 4.66797C14.0012 4.66797 13.8483 4.69839 13.7056 4.75749C13.563 4.81659 13.4333 4.90321 13.3241 5.01241Z" fill="#3A8CE4"/>
                                    </g>
                                    <defs>
                                    <clipPath id="clip0">
                                    <rect width="10.6667" height="10.6667" fill="white" transform="translate(4.66663 4.66998)"/>
                                    </clipPath>
                                    </defs>
                                    </svg>
                                    </div>
